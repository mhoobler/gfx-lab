...
export const BUFFER_USAGE_TABLE: ReadonlyArray<[string, number]> = [
...
export const STEPMODES: ReadonlyArray<GPUVertexStepMode> = [
  "vertex",
  "instance",
] as const;

export const TEXTURE_FORMATS: ReadonlyArray<GPUTextureFormat> = [
  "r8unorm",
  "r8snorm",
  "r8uint",
  "r8sint",
...
export const VERTEX_FORMATS: ReadonlyArray<GPUVertexFormat> = [
  "uint8x2",
  "uint8x4",
  "sint8x2",
  "sint8x4",
